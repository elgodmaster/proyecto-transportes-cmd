                ...
                <form id="Form1" runat="server">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <br />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Campo necesario" ControlToValidate="txtmodel" Display="Dynamic" ValidationGroup="VALIDACION" CssClass="validaciones"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    ...
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            ...
                            <br />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Campo necesario" ControlToValidate="txtPlac" Display="Dynamic" ValidationGroup="VALIDACION" CssClass="validaciones"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Campo necesario" ControlToValidate="txtprimer" Display="Dynamic" ValidationGroup="VALIDACION" CssClass="validaciones"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Ingrese solo números" ControlToValidate="txtprimer" Display="Dynamic" ValidationExpression="^[0-9]*" CssClass="validaciones"></asp:RegularExpressionValidator>
                        </div>
                    </div>
                    <div class="control-group ">
                        ...
                        <div class="controls">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Ingrese solo números" ControlToValidate="txtsegund" Display="Dynamic" CssClass="validaciones"></asp:RegularExpressionValidator>
                        </div>
                    </div>
                    <div class="control-group">
