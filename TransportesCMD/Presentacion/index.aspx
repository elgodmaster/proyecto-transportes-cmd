                        ...
                        <nav>
                            <ul id="top_nav">
                                <li><a href="index.aspx">
                                    <img src="assets/images/img1.gif" alt=""></a></li>

                                <li class="bg_none"><a href="intranet/index.aspx">
                                    <img src="assets/images/img3.gif" alt=""></a></li>
                            </ul>
                        </nav>
                        <nav>
                            <ul id="menu">
                ...
                <div class="pad_1">
                    ...
                    <form id="form_1" action="" method="post">
                        ...
                        <div class="wrapper">
                            Origen:
						<div class="bg">
                            <input type="text" class="input input1" value="Agregar Ciudad de Origen" onblur="if(this.value=='') this.value='Enter City or Airport Code'" onfocus="if(this.value =='Enter City or Airport Code' ) this.value=''"></div>
                        </div>
                        <div class="wrapper">
                            Destino:
						<div class="bg">
                            <input type="text" class="input input1" value="Agregar Ciudad de Destino" onblur="if(this.value=='') this.value='Enter City or Airport Code'" onfocus="if(this.value =='Enter City or Airport Code' ) this.value=''"></div>
                        </div>
                        <div class="wrapper">
                            Fecha y Hora de Salida:
						<div class="wrapper">
                            <div class="bg left">
                                <input type="text" class="input input2" value="mm/dd/aaaa " onblur="if(this.value=='') this.value='mm/dd/yyyy '" onfocus="if(this.value =='mm/dd/yyyy ' ) this.value=''"></div>
                            <div class="bg right">
                                <input type="text" class="input input2" value="12:00am" onblur="if(this.value=='') this.value='12:00am'" onfocus="if(this.value =='12:00am' ) this.value=''"></div>
                        </div>
                        </div>
                        <div class="wrapper">
